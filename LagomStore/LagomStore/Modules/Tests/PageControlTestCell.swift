...
//    var isAutoScrollingEnabled: Bool = true // Флаг для включения/выключения авто-прокрутки
//        
...
//    
//    
//    // Настройка таймера для авто-прокрутки
////    private func startAutoScrollTimer() {
////        guard isAutoScrollingEnabled else { return }
////
////        autoScrollTimer?.invalidate() // Останавливаем предыдущий таймер, если он был
////
////        autoScrollTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(scrollToNextPage), userInfo: nil, repeats: true)
////    }
//    
//    // Остановка таймера для авто-прокрутки
////    private func stopAutoScrollTimer() {
////        autoScrollTimer?.invalidate()
////        autoScrollTimer = nil
////    }
//    
//    // Метод для прокрутки к следующей странице
...
//    }
//    
//    func update(_ model: [PageControlModel], height: CGFloat) {
...
////        guard autoScrollTimer == nil else { return } // Избегаем дублирования таймеров
////
...
//    
////    func scrollViewDidScroll(_ scrollView: UIScrollView) {
////        updateIndicatorProgress() // Обновляем индикаторы при прокрутке
////    }
//    
...
//    }
//
//    func update(_ model: [PageControlModel]) {
//        self.pageControlData = model
//        collectionView.reloadData()
//        setupIndicators()
//    }
